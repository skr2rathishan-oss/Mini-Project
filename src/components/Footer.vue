<template>
  <div class="hidden lg:block w-full border-t border-gray-200 dark:border-slate-700"></div>

  <footer id="site-footer" class="hidden lg:block bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-slate-700 pt-20 pb-10 transition-colors duration-300">
